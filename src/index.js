...
/*import pageTrans from './mainJs'
window.pageTrans = pageTrans;*/
/*require(], function(utils, JQuery, qrcode,aesjs) {
*/
...
requirejs(['jquery', 'qrcode','webcodecamjs','aesjs'], function( $ ) {
